...
\end{verbatim}
This information added to \tx{struct thread} stores information on parent and child threads to allow for synchronisation, and the location of the executing code on the file system.
