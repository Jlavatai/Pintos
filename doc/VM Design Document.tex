...
Also, once a page is read in, it will have an unused_count of 0. When we choose to evict a page, we choose the highest unused_count, where unused_count is both affected by age and how often it is accessed and written to. Thus if a page is recently read in, it is unlikely (very) to be evicted any time soon.
